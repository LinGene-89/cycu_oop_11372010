...
if __name__ == "__main__":
    ...
    if all_routes_info:
        ...
        csv_path = os.path.join(route_list.working_directory, 'all_bus_routes_info.csv')
        all_routes_df.to_csv(csv_path, index=False, encoding='utf-8-sig')
        print(f"✅ Exported all routes info to {csv_path}")
